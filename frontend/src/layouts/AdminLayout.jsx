...
import {
  Brain, LayoutDashboard, Users, BarChart3, FileCheck,
...
const NAV = [
  ...
  { id: 'admin-documents', icon: FileCheck,       label: 'Documents & Approval' },
];
...
const PAGE_LABELS = {
  ...
  'admin-documents': 'Documents & Approval',
};
  ...
  return (
    <div style={{
      ...
      <SidebarShell
        ...
        onLogout={onLogout}
        profile={{ initials: 'AD', name: 'Admin', role: 'Administrator', badge: 'ADMIN', badgeColor: '#fbbf24', badgeBg: 'rgba(251,191,36,0.15)' }}
        nav={NAV}
      />
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        <TopBar pageLabel={PAGE_LABELS[activePage]} avatar="AD" />
